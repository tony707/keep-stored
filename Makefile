#############################################################################
# Makefile for building: KeepStored.app/Contents/MacOS/KeepStored
# Generated by qmake (2.01a) (Qt 4.6.2) on: mer. juin 16 23:02:42 2010
...
DIST          = /usr/local/Qt4.6/mkspecs/common/unix.conf \
		...
		KeepStored.pro
QMAKE_TARGET  = KeepStored
DESTDIR       = 
TARGET        = KeepStored.app/Contents/MacOS/KeepStored
...
all: Makefile KeepStored.app/Contents/PkgInfo KeepStored.app/Contents/Resources/empty.lproj KeepStored.app/Contents/Info.plist $(TARGET)

$(TARGET):  $(OBJECTS)  
	@$(CHK_DIR_EXISTS) KeepStored.app/Contents/MacOS/ || $(MKDIR) KeepStored.app/Contents/MacOS/ 
...
KeepStored.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) KeepStored.app/Contents || $(MKDIR) KeepStored.app/Contents 
	@$(DEL_FILE) KeepStored.app/Contents/PkgInfo
	@echo "APPL????" >KeepStored.app/Contents/PkgInfo
KeepStored.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) KeepStored.app/Contents/Resources || $(MKDIR) KeepStored.app/Contents/Resources 
	@touch KeepStored.app/Contents/Resources/empty.lproj
	
KeepStored.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) KeepStored.app/Contents || $(MKDIR) KeepStored.app/Contents 
	@$(DEL_FILE) KeepStored.app/Contents/Info.plist
	@sed -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,KeepStored,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.6/mkspecs/macx-g++/Info.plist.app >KeepStored.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) bin/KeepStored1.0.0 || $(MKDIR) bin/KeepStored1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) bin/KeepStored1.0.0/ && $(COPY_FILE) --parents src/gui/main_window.hpp src/backend/abstract_resource.hpp bin/KeepStored1.0.0/ && $(COPY_FILE) --parents resources/icons.qrc bin/KeepStored1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/gui/main_window.cpp src/backend/abstract_resource.cpp bin/KeepStored1.0.0/ && (cd `dirname bin/KeepStored1.0.0` && $(TAR) KeepStored1.0.0.tar KeepStored1.0.0 && $(COMPRESS) KeepStored1.0.0.tar) && $(MOVE) `dirname bin/KeepStored1.0.0`/KeepStored1.0.0.tar.gz . && $(DEL_FILE) -r bin/KeepStored1.0.0
